    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 style={{ fontSize: "18px", fontWeight: "700", color: "#0e121b", margin: 0 }}>
            TechFocus
          </h2>
        </div>
      </header>
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            <div
              style={{
                width: "64px",
                height: "64px",
                background: "linear-gradient(135deg, #306de8, #5b8ef0)",
                borderRadius: "16px",
                display: "inline-flex",
                alignItems: "center",
                justifyContent: "center",
                marginBottom: "16px",
                boxShadow: "0 4px 16px rgba(48,109,232,0.3)",
              }}
            >
            ...
            <p style={{ fontSize: "14px", color: "#4e6797", margin: 0 }}>
          ...
          >
            ...
            <span style={{ fontSize: "13px", color: "#4e6797", whiteSpace: "nowrap" }}>
              Sign in with
            </span>
            <div style={{ flex: 1, height: "1px", background: "#e7ebf3" }} />
          </div>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.borderColor = "#306de8";
              e.currentTarget.style.transform = "translateY(-1px)";
              e.currentTarget.style.boxShadow = "0 4px 16px rgba(48,109,232,0.15)";
            }}
            onMouseLeave={(e) => {
